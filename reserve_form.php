...
// DB接続(functions.phpなどでconnect_db関数が定義されている前提)
...
<form action="/public/public/reserve_confirm.php" method="post" class="mx-auto grid max-w-2xl gap-6">
    ...
    <div>
        <h1 class="text-xl font-bold">予約入力</h1>
        <?php
...
EOM;
    ...
    <?php if ($mode === 'edit'): ?>
        <!-- 重複していた hidden 要素 (id / updated_at / course_count) を除去。上部ですでに送信されるためここでは不要 -->
    <?php endif; ?>
